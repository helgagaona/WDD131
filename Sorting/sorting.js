...
const hikes = [
  ...
  console.log("Sorted list of fruits:", simpleSort);
  ...
  console.log("Filtered fruits (contains 'b'):", searchList(simpleList, "b"));
  console.log("Filtered fruits (contains 'an'):", searchList(simpleList, "an"));
  ...
  function searchListHikes(list, query) {
    ...
    const sorted = filtered.sort((a, b) => {
      // Sorting by distance in miles (shortest first)
      return parseFloat(a.distance) - parseFloat(b.distance);
    });
    return sorted;
  }
  
  console.log("Hikes containing 'yellowstone':", searchListHikes(hikes, "yellowstone"));
  console.log("Hikes containing 'moderate':", searchListHikes(hikes, "moderate"));
  console.log("Hikes containing 'al':", searchListHikes(hikes, "al"));
