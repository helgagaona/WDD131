...
function tagTemplate(tags) {
    // This converts the array of tags into individual buttons
...
function hikeTemplate(hike) {
    // This generates the full HTML for a hike card
    return `
        <div class="hike-card">
...
// MAIN LOGIC - Filtering, Sorting, and Showing Results
function renderHikes(hikeList) {
    // Clear the container first
    hikeContainer.innerHTML = '';

    // Build the HTML for all hikes in the provided list
...
function search() {
    ...
    // TO FILTER: Check name, description, and tags
    ...
    // TO SORT: By distance (using parseFloat to handle "3 miles" as 3)
