...
// Reference to the main container where the articles will be inserted
...
function insertArticles() {
    // Loop through each article and insert it into the page
    articles.forEach((article) => {
        const articleHTML = generateArticleHTML(article);
        mainContainer.insertAdjacentHTML('beforeend', articleHTML); // Insert HTML dynamically
    });
}

// Run the insertArticles function after the page is loaded
