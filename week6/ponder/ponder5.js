...
const movies = [
    ...
    return `
        <article class="movie">
            ...
            <p><strong>Rating:</strong> <span aria-label="${item.stars} out of 5 stars">${item.stars}</span></p>
    ...
    movies.forEach(movie => {
        const articleHTML = generateHTML(movie);
        const movieList = document.getElementById('movie-list');
        movieList.insertAdjacentHTML('beforeend', articleHTML);   
    });
